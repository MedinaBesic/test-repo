...
graduation_csv=os.path.join('/Users', 'adnanbesic', 'desktop', 'classfolder', 'Activity_3.3', '08-Evr_GraduatingFunctions', 'Resources', 'graduation_data.csv')
...
#Public school grad rate can be found by dividing the total public graduates by total public students * 100
...
#If overall grad rate is > 50 , message is "Graduation Succes":
